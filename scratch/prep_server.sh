...
apt install autossh mongodb wget virtualenv openvpn iptables-persistent unison=2.40.102-2 screen realvnc-vnc-server python-dev
...
echo 'xserver-command=X -s 0 -dpms' >>  /etc/lightdm/lightdm.
...
pip install pyramid pyramid-debugtoolbar pyramid-jinja2 waitress cookiecutter
...
printf "\n=======================================\n"
echo "NOW FOLLOW INSTRUCTIONS IN /home/pi/readme.txt"
printf "\n=======================================\n"
...
echo "Configure gateway with... 'minicom (sudo minicom -b 115200 -o -D /dev/serial0)'... then set neti" > /home/pi/readme.txt
...
echo "If desirable uncomment #dtoverlay=pi3-disable-wifi in /boot/config.txt" > /home/pi/readme.txt
